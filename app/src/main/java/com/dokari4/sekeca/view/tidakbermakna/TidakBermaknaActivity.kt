package com.dokari4.sekeca.view.tidakbermakna
...
import com.dokari4.sekeca.databinding.ActivityTidakBermaknaBinding
...
import com.dokari4.sekeca.view.result.ResultActivity
import com.dokari4.sekeca.viewmodels.ViewModel

class TidakBermaknaActivity : AppCompatActivity(), QuestionClickHandler {
    private lateinit var binding: ActivityTidakBermaknaBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //Set Binding
        binding = ActivityTidakBermaknaBinding.inflate(layoutInflater)
        ...
        viewmodel.getKataTidakBermaknaQuestion.observe(this) {
        ...
        binding.recyclerView.apply {
            this.layoutManager = LinearLayoutManager(this@TidakBermaknaActivity)
