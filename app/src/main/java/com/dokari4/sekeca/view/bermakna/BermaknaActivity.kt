...
import com.dokari4.sekeca.databinding.ActivityBermaknaBinding
...
import com.dokari4.sekeca.view.tidakbermakna.TidakBermaknaActivity
import com.dokari4.sekeca.viewmodels.ViewModel

class BermaknaActivity : AppCompatActivity(), QuestionClickHandler {
    private lateinit var binding: ActivityBermaknaBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //Set Binding
        binding = ActivityBermaknaBinding.inflate(layoutInflater)
        ...
        viewmodel.getKataBermaknaQuestion.observe(this) {
        ...
        binding.recyclerView.apply {
            this.layoutManager = LinearLayoutManager(this@BermaknaActivity)
        ...
        binding.btnNext.setOnClickListener {
            val intent = Intent(this, TidakBermaknaActivity::class.java)
